...
enable this option.
/  Enabled for the SD file browser (Project A, Phase 1): attribute view/edit
/  (toggle AM_RDO/AM_HID) and to clear AM_RDO before f_unlink on read-only
/  files. See docs/ROADMAP.md "Project A". */
