...
- **Done** (all committed):
  ...
  - **P4** settings menu + **5 themes** + `/file_browser_gba.cfg` persistence + last-folder reopen + show-hidden + **reboot-to-loader** — commit `61783e8`. *Reboot HW-confirmed on Omega DE (lands on the EZ-Flash kernel menu).*
